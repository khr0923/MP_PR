...
//        return view
        ...
        adapter.setItemClickListener(object: ImageAdapter.ClickListener{
            override fun onClick(v: View, position: Int) {
                //Toast.makeText(context, "${dmList[position].rdDetailImg}", Toast.LENGTH_SHORT).show()

                val intent: Intent = Intent(context, RoadmapDetailActivity::class.java)


//                var outputStream1: OutputStream? = ByteArrayOutputStream()
//                var outputStream2: OutputStream? = ByteArrayOutputStream()
//                var outputStream3: OutputStream? = ByteArrayOutputStream()
//                var outputStream4: OutputStream? = ByteArrayOutputStream()
//                var outputStream5: OutputStream? = ByteArrayOutputStream()
//
//                sendBitmap_front.compress(Bitmap.CompressFormat.PNG, 100, outputStream1)
//                sendBitmap_front.compress(Bitmap.CompressFormat.PNG, 100, outputStream2)
//                sendBitmap_front.compress(Bitmap.CompressFormat.PNG, 100, outputStream3)
//                sendBitmap_front.compress(Bitmap.CompressFormat.PNG, 100, outputStream4)
//                sendBitmap_front.compress(Bitmap.CompressFormat.PNG, 100, outputStream5)
//
//                var byteArray: ByteArray = outputStream1.toByteArray()
...
//        var sendBitmap_front: Bitmap = BitmapFactory.decodeResource(context?.getResources(), R.drawable.rd_front_end)
//        var sendBitmap_back: Bitmap = BitmapFactory.decodeResource(context?.getResources(), R.drawable.rd_back_end)
//        var sendBitmap_game: Bitmap = BitmapFactory.decodeResource(context?.getResources(), R.drawable.rd_game)
//        var sendBitmap_mobile: Bitmap = BitmapFactory.decodeResource(context?.getResources(), R.drawable.rd_mobile)
//        var sendBitmap_data: Bitmap = BitmapFactory.decodeResource(context?.getResources(), R.drawable.rd_data_analyst)
